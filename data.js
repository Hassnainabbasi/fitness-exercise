const AllExercises = [
  [
    ...
    },
    {
      ...
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/11/00151301-Assisted-Parallel-Close-Grip-Pull-up_Back_360.gif",
      id: "0015",
      name: "Asst CG Pull-Up",
      target: "lats",
    ...
    },
    {
      ...
      equipment: "leverage machine",
      gifUrl:
        "https://www.inspireusafoundation.org/wp-content/uploads/2023/06/assisted-pull-up-machine.gif",
      id: "0017",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://www.inspireusafoundation.org/wp-content/uploads/2023/07/barbell-pullover.gif",
      id: "0022",
      name: "BB Pullover Press",
      target: "lats",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/11/00271301-Barbell-Bent-Over-Row_Back-FIX_360.gif",
      id: "0027",
      name: "Barbell Row",
      target: "upper back",
      secondaryMuscles: ["biceps", "forearms"],
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://i.pinimg.com/originals/e4/e6/a0/e4e6a079c5b113da52ffeb21136a4121.gif",
      id: "0034",
      name: "BB Bent Arm Pullover",
      target: "lats",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://i.pinimg.com/originals/fe/67/06/fe670655fcc120022ff2acaee0de9a27.gif",
      id: "0049",
      name: "BB Inline Row",
      target: "upper back",
      secondaryMuscles: ["biceps", "forearms"],
  ...
  [
    {
      ...
      description:
        "The jack burpee is a high-intensity, full-body exercise that combines a squat, push-up, and jump to elevate heart rate and improve cardiovascular fitness while also engaging multiple muscle groups.",
      difficulty: "advanced",
      category: "cardio",
    },
    {
      bodyPart: "cardio",
      equipment: "body weight",
      gifUrl: "https://burnfit.io/wp-content/uploads/2023/11/MOUNT_CLIMB.gif",
      id: "0630",
    ...
    },
    {
      bodyPart: "cardio",
      equipment: "body weight",
      gifUrl: "https://gymvisual.com/img/p/2/5/0/2/4/25024.gif",
      id: "0684",
      name: "Treadmill Run",
      target: "cardiovascular system",
      ...
      description:
        "Running in place is a cardiovascular exercise that elevates the heart rate and improves overall endurance. It requires no equipment and can be performed anywhere, making it accessible for most fitness levels.",
      difficulty: "beginner",
      category: "cardio",
    },
    {
      bodyPart: "cardio",
      equipment: "leverage machine",
      gifUrl: "https://gymvisual.com/img/p/8/7/5/9/8759.gif",
      id: "0798",
      name: "Light Bike Ride",
      target: "cardiovascular system",
      secondaryMuscles: ["quadriceps", "hamstrings", "calves"],
      instructions: [
    ...
    },
    {
      ...
      equipment: "body weight",
      gifUrl:
        "https://www.inspireusafoundation.org/wp-content/uploads/2023/11/half-burpee.gif",
      id: "1160",
      name: "Burpee",
      target: "cardiovascular system",
      secondaryMuscles: [
      ...
      description:
        "The burpee is a full-body exercise that combines a squat, push-up, and jump to elevate heart rate and build strength and endurance.",
      difficulty: "intermediate",
      category: "cardio",
    },
    {
      ...
      equipment: "dumbbell",
      gifUrl:
        "https://www.inspireusafoundation.org/wp-content/uploads/2022/02/dumbbell-burpee-movement.gif",
      id: "1201",
    ...
    },
    {
      ...
      gifUrl: "https://pitpowerapp.pt/wp-content/uploads/2022/01/219213.gif",
      id: "2141",
      name: "Elliptical Walk",
      target: "cardiovascular system",
      ...
      description:
        "The walk elliptical cross trainer is a cardiovascular exercise performed on an elliptical machine. It simulates a walking or running motion with low impact on the joints, making it suitable for a wide range of fitness levels. The exercise targets the cardiovascular system while also engaging the quadriceps, hamstrings, glutes, and calves.",
      difficulty: "beginner",
      category: "cardio",
    },
    {
      ...
      gifUrl: "https://gymvisual.com/img/p/9/3/9/6/9396.gif",
      id: "2311",
      name: "Stepmill Walk",
      target: "cardiovascular system",
      secondaryMuscles: ["quadriceps", "hamstrings", "glutes", "calves"],
      ...
      description:
        "Walking on a stepmill is a cardiovascular exercise performed on a machine that simulates stair climbing. It primarily targets the cardiovascular system while also engaging the lower body muscles.",
      difficulty: "beginner",
      category: "cardio",
    },
  ],
  [
    {
      ...
      gifUrl: "https://gymvisual.com/img/p/1/5/1/6/7/15167.gif",
      id: "0018",
      name: "Assisted Towel Triceps",
      target: "triceps",
    ...
    },
    {
      ...
      equipment: "leverage machine",
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/11/00091301-Assisted-Chest-Dip-kneeling_Chest_360.gif",
      id: "0019",
      name: "Kneeling Triceps Dip",
      target: "triceps",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://www.inspireusafoundation.org/wp-content/uploads/2022/01/drag-curl.gif",
      id: "0038",
      name: "BB drag curl",
      target: "biceps",
      secondaryMuscles: ["forearms"],
    ...
    },
    {
      bodyPart: "upper arms",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/5/8/6/7/5867.gif",
      id: "0048",
      name: "Incline Reverse Press",
      target: "triceps",
      secondaryMuscles: ["chest", "shoulders"],
      instructions: [
        "Set up an incline bench at a 45-degree angle.",
    ...
    },
    {
      bodyPart: "upper arms",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/3/1/5/1/0/31510.gif",
      id: "0052",
      name: "BB JM Press",
      target: "triceps",
      secondaryMuscles: ["chest", "shoulders"],
  ...
  [
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLNCQPiZh-p-PsLHTrtF6Kivo3mFP6G3o9iQ&s",
      id: "0025",
      name: "BB bench press",
      target: "pectorals",
      secondaryMuscles: ["triceps", "shoulders"],
    ...
    },
    {
      bodyPart: "chest",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/7/7/6/4776.gif",
      id: "0045",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/11/00471301-Barbell-Incline-Bench-Press_Chest_360.gif",
      id: "0047",
    ...
    },
    {
      bodyPart: "chest",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/7/8/1/4781.gif",
      id: "0050",
    ...
    },
    {
      bodyPart: "chest",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/6/5/2/5/6525.gif",
      id: "0122",
    ...
    },
    {
      bodyPart: "chest",
      equipment: "cable",
      gifUrl: "https://gymvisual.com/img/p/1/6/8/4/3/16843.gif",
      id: "0151",
  ...
  [
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://www.inspireusafoundation.org/wp-content/uploads/2023/03/barbell-reverse-wrist-curl.gif",
      id: "0079",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/11/01041301-Barbell-Standing-Back-Wrist-Curl_Forearms_360.gif",
      id: "0104",
      name: "BB Back Curl",
      target: "forearms",
    ...
    },
    {
      bodyPart: "lower arms",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/2/8/1/6/4/28164.gif",
      id: "0125",
      name: "BB wrist curl",
      target: "forearms",
      secondaryMuscles: ["biceps", "brachialis"],
      ...
      description:
        "The barbell wrist curl v. 2 is an isolation exercise that targets the forearm muscles, specifically the wrist flexors. It is performed seated, with the forearms resting on the thighs and the wrists hanging off the edge, curling a barbell upward using only the wrists.",
      difficulty: "beginner",
      category: "strength",
    },
    {
      ...
      equipment: "cable",
      gifUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRd9FXWH2Tq5sP9ck3ttrLh3tEPGDBDGN-tfA&s",
      id: "0210",
      name: "Reverse Cable Cur",
      target: "forearms",
    ...
    },
    {
      ...
      equipment: "cable",
      gifUrl:
        "https://www.lyfta.app/_next/image?url=https%3A%2F%2Flyfta.app%2Fimages%2Fexercises%2F02101101.png&w=640&q=80",
      id: "0247",
    ...
    },
    {
      bodyPart: "lower arms",
      equipment: "dumbbell",
      gifUrl: "https://gymvisual.com/img/p/1/1/8/6/0/11860.gif",
      id: "0347",
    ...
    },
    {
      bodyPart: "lower arms",
      equipment: "dumbbell",
      gifUrl: "https://gymvisual.com/img/p/5/0/9/0/5090.gif",
      id: "0349",
      ...
      description:
        "The dumbbell lying supination is an isolation exercise targeting the forearms, specifically focusing on the supinator muscles. It also engages the biceps and shoulders as secondary muscles. The movement involves curling dumbbells while lying on a bench, emphasizing forearm rotation and strength.",
      difficulty: "beginner",
      category: "strength",
    },
  ],
  [
    {
      bodyPart: "neck",
      equipment: "body weight",
      gifUrl: "https://gymvisual.com/img/p/5/4/4/3/5443.gif",
      id: "0716",
    ...
    },
    {
      bodyPart: "neck",
      equipment: "body weight",
      gifUrl: "https://gymvisual.com/img/p/3/0/2/2/9/30229.gif",
      id: "1403",
      ...
      description:
        "A gentle stretch targeting the side of the neck, primarily the levator scapulae, performed by tilting the head to the side while standing or sitting.",
      difficulty: "beginner",
      category: "stretching",
    },
  ],
  [
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://burnfit.io/wp-content/uploads/2023/11/BB_FRONT_RAISE.gif",
      id: "0041",
      name: "BB front raise",
      target: "delts",
    ...
    },
    {
      bodyPart: "shoulders",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/7/9/8/4798.gif",
      id: "0067",
    ...
    },
    {
      bodyPart: "shoulders",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/8/0/7/4807.gif",
      id: "0076",
      name: "BB Rear Delt Row",
      target: "delts",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRho6EQx2fmnEGBImU7cGBZkXSHHy-qIXVSBQ&s",
      id: "0087",
      name: "Rocky Press",
      target: "delts",
      secondaryMuscles: ["triceps", "upper back"],
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/11/00911301-Barbell-Seated-Overhead-Press_Shoulders_360.gif",
      id: "0091",
      name: "Seated BB Press",
      target: "delts",
      secondaryMuscles: ["triceps", "upper back"],
      instructions: [
        "Sit on a bench with your back straight and feet flat on the ground.",
  ...
  [
    {
      bodyPart: "lower legs",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/8/2/5/4825.gif",
      id: "0088",
      name: "BB Seated Calf",
      target: "calves",
    ...
    },
    {
      bodyPart: "lower legs",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/8/4/6/4846.gif",
      id: "0108",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://ccuuubmtdurkmbeufybi.supabase.co/storage/v1/object/public/animations/0111.gif",
      id: "0111",
    ...
    },
    {
      ...
      description:
        "The donkey calf raise is a bodyweight exercise that targets the calves. It involves standing with your toes on an elevated surface and raising your heels as high as possible to work the calf muscles.",
      difficulty: "beginner",
      category: "strength",
    },
    {
      bodyPart: "lower legs",
      equipment: "dumbbell",
      gifUrl: "https://gymvisual.com/img/p/6/6/4/3/6643.gif",
      id: "0400",
      name: "DB Single Calf Raise",
      target: "calves",
      secondaryMuscles: ["hamstrings", "glutes"],
      instructions: [
      ...
      description:
        "The dumbbell seated one leg calf raise is an isolation exercise targeting the calf muscles, performed while seated with a dumbbell placed on the working thigh. It helps build strength and muscle in the calves, with some engagement of the hamstrings and glutes for stabilization.",
      difficulty: "beginner",
      category: "strength",
    },
    {
      bodyPart: "lower legs",
      equipment: "dumbbell",
      gifUrl: "https://gymvisual.com/img/p/1/6/9/2/9/16929.gif",
      id: "0417",
      name: "DB Calf Raise",
      target: "calves",
    ...
    },
    {
      bodyPart: "lower legs",
      equipment: "leverage machine",
      gifUrl: "https://gymvisual.com/img/p/5/3/3/1/5331.gif",
      id: "0594",
      ...
      description:
        "The lever seated calf raise is a machine-based exercise that targets the calf muscles, particularly the gastrocnemius and soleus. It is performed while seated, using a leverage machine to provide resistance as you raise and lower your heels.",
      difficulty: "beginner",
      category: "strength",
    },
  ],
  [
    {
      bodyPart: "upper legs",
      equipment: "assisted",
      gifUrl: "https://gymvisual.com/img/p/4/7/4/7/4747.gif",
      id: "0016",
      name: "Assist Prone Hamstring",
      target: "hamstrings",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://i.pinimg.com/originals/aa/57/b8/aa57b81041d254123503f8ae3c710ab2.gif",
      id: "0024",
    ...
    },
    {
      bodyPart: "upper legs",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/1/8/5/5/7/18557.gif",
      id: "0026",
      name: "BB Bench Squat",
      target: "quads",
    ...
    },
    {
      bodyPart: "upper legs",
      equipment: "barbell",
      gifUrl: "https://gymvisual.com/img/p/4/7/5/9/4759.gif",
      id: "0028",
      name: "BB Clean & Press",
      target: "quads",
    ...
    },
    {
      ...
      equipment: "barbell",
      gifUrl:
        "https://newlife.com.cy/wp-content/uploads/2019/12/27281301-StrongMan-Front-Chest-Squat_Weightlifting_360.gif",
      id: "0042",
      name: "BB Front Squat",
      target: "glutes",
      secondaryMuscles: ["quadriceps", "hamstrings", "calves", "core"],
    ...
    },
    {
      bodyPart: "upper legs",
      equipment: "barbell",
      gifUrl: "https://media.tenor.com/Pfj8vy41k-0AAAAM/gym.gif",
      id: "0043",
      name: "BB Full Squat",
      target: "glutes",
      secondaryMuscles: ["quadriceps", "hamstrings", "calves", "core"],
  ...
  [
    {
      ...
      equipment: "body weight",
      gifUrl:
        "https://liftmanual.com/wp-content/uploads/2023/04/3-4-sit-up.gif",
      id: "0001",
      name: "3/4 Sit-Up",
      target: "abs",
    ...
    },
    {
      bodyPart: "waist",
      equipment: "body weight",
      gifUrl: "https://gymvisual.com/img/p/4/7/3/2/4732.gif",
      id: "0002",
      name: "45° Side Bend",
      target: "abs",
    ...
    },
    {
      ...
      equipment: "body weight",
      gifUrl:
        "https://homeworkouts.org/wp-content/uploads/anim-alternate-heel-touches.gif",
      id: "0006",
      name: "Alt Heel Touchers",
      target: "abs",
      secondaryMuscles: ["obliques"],
      instructions: [
        "Lie flat on your back with your knees bent and feet flat on the ground.",
    ...
    },
    {
      bodyPart: "waist",
      equipment: "assisted",
      gifUrl: "https://gymvisual.com/img/p/4/7/4/1/4741.gif",
      id: "0010",
      name: "Partner Knee Raise",
      target: "abs",
      secondaryMuscles: ["hip flexors", "lower back"],
      instructions: [
    ...
    },
    {
      bodyPart: "waist",
      equipment: "assisted",
      gifUrl: "https://gymvisual.com/img/p/4/7/4/2/4742.gif",
      id: "0011",
      name: "Assisted Knee Raise",
      target: "abs",
    ...
    },
    {
      ...
      equipment: "assisted",
      gifUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ9aSZalmL-KhFIl7KUFwmWTM0i60hZ-U4-w&s",
      id: "0012",
      name: "Lateral Leg Throwdown",
      target: "abs",
    ...
    },
    {
      ...
      equipment: "assisted",
      gifUrl:
        "https://fitnessvolt.com/wp-content/uploads/exercises/1080/assisted-lying-leg-raise-with-throw-down-0013.gif",
      id: "0013",
      name: "Partner Leg Raise",
      target: "abs",
    ...
    },
    {
      ...
      gifUrl: "https://gymvisual.com/img/p/4/7/4/5/4745.gif",
      id: "0014",
